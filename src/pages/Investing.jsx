...
const Investing = () => {
  return (
    <section
      className="h-[100dvh] bg-[#00D54B] 
    snap-start relative overflow-y-hidden"
    >
      <div
        className="absolute w-[100%] mob:!h-[100%] 
      mob:top-[2%] revsmlap:top-[50%] left-[50%] -translate-x-[50%]
       revsmlap:-translate-y-[60%] smlap:top-[3%] flex 
       flex-col gap-16 smlap:gap-12 mob:!gap-5 
       items-center z-50 mob:!justify-center"
      >
        <h1
          className="text-3xl mob:text-xl 
        font-Agrandir text-white"
        >
          Investing
        </h1>
        <div
          className="mob:w-[86dvw] flex flex-row gap-20 smlap:gap-10 
        mob:!h-full items-center mob:!flex-col 
        mob:!h-full mob:!justify-evenly mob:!pb-7"
        >
          <div
            className="flex flex-row gap-8 justify-center items-center
           smlap:flex-row-reverse mob:!flex-col-reverse mob:!gap-6"
          >
            <div className="revsmlap:-translate-y-[50%]">
              <h1
                className="text-xl text-black font-Agrandir
               mob:!text-[16px]"
              >
                Stocks
              </h1>
              ...
              text-black font-Mulish mob:text-sm smlap:w-[300px]"
              >
          ...
          items-center mob:!flex-col mob:!gap-6"
          >
            <img
