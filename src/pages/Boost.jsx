const Boost = () => {
  return (
    ...
    >
      ...
      smlap:flex-col-reverse revsmlap:w-[24vw] top-[50%] right-[50%]
       -translate-y-[50%] -translate-x-[22%] mob:top-[42%] 
       smlap:w-[300px] smlap:translate-x-[50%] smlap:gap-8 mob:!w-[200px] z-50"
      >
        <div className="relative z-10 revsmlap:bottom-16">
          ...
          <p
           ...
           text-white font-Mulish mob:text-sm"
          >
      ...
      <img
        ...
        alt="Boost Shoe"
        className="absolute bottom-[34.7%] 
        right-[1.4%] w-[6.5%] smlap:!hidden
         mdlap:translate-y-[15%]"
      />
      <img
        src="/assets/boost-coffee.png"
        alt="Boost Coffee"
        className="absolute bottom-[16%] right-[20%]
         w-[5%] smlap:hidden mdlap:translate-y-[15%]"
      />
      <img
        src="/assets/boost-burger.png"
        alt="Boost Burger"
        className="absolute bottom-[35%] right-[26.5%]
         w-[4.8%] smlap:hidden mdlap:translate-y-[15%]"
      />
      <img
        src="/assets/boost-card.png"
        alt="Boost Card"
        className="absolute bottom-[55%] right-[20%]
         w-[5%] smlap:hidden mdlap:translate-y-[15%]"
      />
      <img
        src="/assets/boost-hand.png"
        alt="Boost Hand"
        className="absolute top-[12%] right-[13%]
         w-[4.7%] smlap:hidden mdlap:translate-y-[22%]"
      />
    </section>
  );
};
